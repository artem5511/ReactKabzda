...
export const ModeChanging = () => {
    ...
    return <Accordion titleValue={"Users"} collapsed={value} onChange={()=> setValue(!value)} items={[{title: 'Artem', value: 1},{title: 'Viktor', value: 2},{title: 'Igor',value:3},{title:'Valera',value:4}]} onClick={onClickcallback}/>;
};